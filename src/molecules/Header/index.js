          ...
          <div className="col px-0">
            ...
            <div className="row mt-lg">
              <div className="col-md-4 text-white text-center">
                <img src="https://s3.amazonaws.com/scubrasil-design/images/icons/circular_check.svg" alt="check icon" />
                <p className="mt-4">Menor preço 100% garantido</p>
              </div>
              <div className="col-md-4 text-white text-center">
                <img src="https://s3.amazonaws.com/scubrasil-design/images/icons/support.svg" alt="check icon" />
                <p className="mt-4">Suporte online para tirar suas dúvidas</p>
              </div>
              <div className="col-md-4 text-white text-center">
                <img src="https://s3.amazonaws.com/scubrasil-design/images/icons/credit_card_hand.svg" alt="check icon" />
